...
use crate::peers::{
    LastWrite, PeerMessage, Peers, ReadDeadline, dispatch_actions, peer_reader, peer_writer,
};
...
impl crate::types::PacketConn for PacketConnImpl {
    ...
    fn mtu(&self) -> u64 {
        ...
        self.config
            ...
            .saturating_sub(overhead as u64)
    }
...
impl PacketConnImpl {
    ...
    pub async fn count_lookup_targets(&self, dest: PublicKey) -> (PublicKey, usize) {
        self.router_handle.query_count_lookup_targets(dest).await
    }
